...
| 4.4 | Isaac ROS FoundationPose 6D pose and acceleration | Isaac ROS 3.2 container | **PARTIAL** — official FP32/252 Mustard pose passed; physical RGB-D gate open | [中文](./4.4_Isaac_ROS_FoundationPose_and_Acceleration/README_zh_CN.md) / [English](./4.4_Isaac_ROS_FoundationPose_and_Acceleration/README_en_US.md) |

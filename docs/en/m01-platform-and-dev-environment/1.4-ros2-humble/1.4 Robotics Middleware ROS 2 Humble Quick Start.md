...
>
> - **M2.3** will use `isaac_ros_image_pipeline` to implement GPU-accelerated undistortion and format conversion of CSI camera images
> - **M2.5** will use `isaac_ros_apriltag` to implement visual tag localization
...
>
> **Next step**: M2 Perception Layer — starting with "seeing", connecting CSI cameras and USB cameras, and leveraging the GPU to accelerate image processing.
